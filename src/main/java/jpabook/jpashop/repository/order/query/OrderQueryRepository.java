...
public class OrderQueryRepository {
    ...
    public List<OrderFlat> findOrdersFlatWithName(String name) {
        System.out.println("name = " + name);
        return em.createQuery(
                "select new" +
                        " jpabook.jpashop.web.form.query.OrderFlat(o.id, m.name, o.orderDate, o.status, i.name, i.price, oi.count)" +
                        " from Order o" +
                        " join o.member m" +
                        " join o.orderItems oi" +
                        " join oi.item i" +
                        " where m.name like :name", OrderFlat.class
        )
