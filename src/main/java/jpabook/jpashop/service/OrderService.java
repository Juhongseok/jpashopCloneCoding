...
public class OrderService {
    ...
    public List<OrderDto> findOrdersWithMember(OrderSearch orderSearch) {
        return orderRepository.findOrders(orderSearch);
    }

    public List<OrderFlat> findOrdersFlat(OrderSearch orderSearch) {
        return orderRepository.findOrdersFlat(orderSearch);
    }
}
